...
export class Api {
  ...
  get = async (endpoint: string, config: AxiosRequestConfig, failOnError = true): Promise<object> => {
  ...
  post = async (endpoint: string, requestObject: object, config: AxiosRequestConfig, failOnError = true): Promise<object> => {
    this.logRequest(requestObject, config)
    try {
      this.response = await this.axiosInstance.post(endpoint, requestObject, config)
      this.logResponse()
      return this.response.data
    } catch (error) {
      this.logError(error, failOnError)
  ...
  put = async (endpoint: string, requestObject: object, config: AxiosRequestConfig, failOnError = true): Promise<object> => {
    this.logRequest(requestObject, config)
    try {
      this.response = await this.axiosInstance.put(endpoint, requestObject, config)
      this.logResponse()
      return this.response.data
    } catch (error) {
      this.logError(error, failOnError)
  ...
  delete = async (endpoint: string, config: AxiosRequestConfig, failOnError = true): Promise<object> => {
    this.logRequest({}, config)
    try {
