...
export default class LocalPathReducer extends BaseReducer {
    ...
    [LocalPathActions.REQUEST_LOCALPATH_SUCCESS](state: LocalPathState, action: AnyAction) {
        return {
            ...state,
            data: action.payload
        };
    ...
    [LocalPathActions.REQUEST_LOCALPATH_FAILURE](state: LocalPathState, action: AnyAction) {
        return {
            ...state,
            error: action.error
        };
